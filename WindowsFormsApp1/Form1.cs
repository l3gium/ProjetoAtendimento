...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void InitializeUI()
        {
            ...
            lblQtdGuichesText.Location = new Point(240, 20);
            this.Controls.Add(lblQtdGuichesText);

            lblQtdGuiches = new Label();
            lblQtdGuiches.Text = "0";
            lblQtdGuiches.Size = new Size(30, 20);
            lblQtdGuiches.Location = new Point(320, 20);
            ...
            btnAdicionarGuiche.Location = new Point(240, 50);
